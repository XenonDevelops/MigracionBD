...
public class FechaExamenJpaController implements Serializable {
    ...
    public void create(FechaExamen fechaExamen) {
        ...
        if (fechaExamen.getAsignacionExamenimpresoList() == null) {
            fechaExamen.setAsignacionExamenimpresoList(new ArrayList<AsignacionExamenimpreso>());
        }
        ...
        try {
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListAsignacionExamenimpresoToAttach : fechaExamen.getAsignacionExamenimpresoList()) {
            ...
            fechaExamen.setAsignacionExamenimpresoList(attachedAsignacionExamenimpresoList);
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListAsignacionExamenimpreso : fechaExamen.getAsignacionExamenimpresoList()) {
                FechaExamen oldFechaExamenOfAsignacionExamenimpresoListAsignacionExamenimpreso = asignacionExamenimpresoListAsignacionExamenimpreso.getFechaExamen();
                asignacionExamenimpresoListAsignacionExamenimpreso.setFechaExamen(fechaExamen);
                asignacionExamenimpresoListAsignacionExamenimpreso = em.merge(asignacionExamenimpresoListAsignacionExamenimpreso);
                if (oldFechaExamenOfAsignacionExamenimpresoListAsignacionExamenimpreso != null) {
                    oldFechaExamenOfAsignacionExamenimpresoListAsignacionExamenimpreso.getAsignacionExamenimpresoList().remove(asignacionExamenimpresoListAsignacionExamenimpreso);
                    oldFechaExamenOfAsignacionExamenimpresoListAsignacionExamenimpreso = em.merge(oldFechaExamenOfAsignacionExamenimpresoListAsignacionExamenimpreso);
                }
            }
    ...
    public void edit(FechaExamen fechaExamen) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<AsignacionExamenimpreso> asignacionExamenimpresoListOld = persistentFechaExamen.getAsignacionExamenimpresoList();
            List<AsignacionExamenimpreso> asignacionExamenimpresoListNew = fechaExamen.getAsignacionExamenimpresoList();
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListOldAsignacionExamenimpreso : asignacionExamenimpresoListOld) {
                if (!asignacionExamenimpresoListNew.contains(asignacionExamenimpresoListOldAsignacionExamenimpreso)) {
                    ...
                    illegalOrphanMessages.add("You must retain AsignacionExamenimpreso " + asignacionExamenimpresoListOldAsignacionExamenimpreso + " since its fechaExamen field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            fechaExamen.setAsignacionExamenimpresoList(asignacionExamenimpresoListNew);
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListNewAsignacionExamenimpreso : asignacionExamenimpresoListNew) {
                if (!asignacionExamenimpresoListOld.contains(asignacionExamenimpresoListNewAsignacionExamenimpreso)) {
                    FechaExamen oldFechaExamenOfAsignacionExamenimpresoListNewAsignacionExamenimpreso = asignacionExamenimpresoListNewAsignacionExamenimpreso.getFechaExamen();
                    asignacionExamenimpresoListNewAsignacionExamenimpreso.setFechaExamen(fechaExamen);
                    asignacionExamenimpresoListNewAsignacionExamenimpreso = em.merge(asignacionExamenimpresoListNewAsignacionExamenimpreso);
                    if (oldFechaExamenOfAsignacionExamenimpresoListNewAsignacionExamenimpreso != null && !oldFechaExamenOfAsignacionExamenimpresoListNewAsignacionExamenimpreso.equals(fechaExamen)) {
                        oldFechaExamenOfAsignacionExamenimpresoListNewAsignacionExamenimpreso.getAsignacionExamenimpresoList().remove(asignacionExamenimpresoListNewAsignacionExamenimpreso);
                        oldFechaExamenOfAsignacionExamenimpresoListNewAsignacionExamenimpreso = em.merge(oldFechaExamenOfAsignacionExamenimpresoListNewAsignacionExamenimpreso);
                    }
                }
            }
    ...
    public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<AsignacionExamenimpreso> asignacionExamenimpresoListOrphanCheck = fechaExamen.getAsignacionExamenimpresoList();
            for (AsignacionExamenimpreso asignacionExamenimpresoListOrphanCheckAsignacionExamenimpreso : asignacionExamenimpresoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This FechaExamen (" + fechaExamen + ") cannot be destroyed since the AsignacionExamenimpreso " + asignacionExamenimpresoListOrphanCheckAsignacionExamenimpreso + " in its asignacionExamenimpresoList field has a non-nullable fechaExamen field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
