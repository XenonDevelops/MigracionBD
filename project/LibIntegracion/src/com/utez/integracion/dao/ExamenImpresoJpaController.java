...
public class ExamenImpresoJpaController implements Serializable {
    ...
    public void create(ExamenImpreso examenImpreso) {
        ...
        if (examenImpreso.getAsignacionExamenimpresoList() == null) {
            examenImpreso.setAsignacionExamenimpresoList(new ArrayList<AsignacionExamenimpreso>());
        }
        ...
        try {
            ...
            List<AsignacionExamenimpreso> attachedAsignacionExamenimpresoList = new ArrayList<AsignacionExamenimpreso>();
            for (AsignacionExamenimpreso asignacionExamenimpresoListAsignacionExamenimpresoToAttach : examenImpreso.getAsignacionExamenimpresoList()) {
                asignacionExamenimpresoListAsignacionExamenimpresoToAttach = em.getReference(asignacionExamenimpresoListAsignacionExamenimpresoToAttach.getClass(), asignacionExamenimpresoListAsignacionExamenimpresoToAttach.getAsignacionExamenimpresoPK());
                attachedAsignacionExamenimpresoList.add(asignacionExamenimpresoListAsignacionExamenimpresoToAttach);
            }
            examenImpreso.setAsignacionExamenimpresoList(attachedAsignacionExamenimpresoList);
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListAsignacionExamenimpreso : examenImpreso.getAsignacionExamenimpresoList()) {
                ExamenImpreso oldExamenImpresoOfAsignacionExamenimpresoListAsignacionExamenimpreso = asignacionExamenimpresoListAsignacionExamenimpreso.getExamenImpreso();
                asignacionExamenimpresoListAsignacionExamenimpreso.setExamenImpreso(examenImpreso);
                asignacionExamenimpresoListAsignacionExamenimpreso = em.merge(asignacionExamenimpresoListAsignacionExamenimpreso);
                if (oldExamenImpresoOfAsignacionExamenimpresoListAsignacionExamenimpreso != null) {
                    oldExamenImpresoOfAsignacionExamenimpresoListAsignacionExamenimpreso.getAsignacionExamenimpresoList().remove(asignacionExamenimpresoListAsignacionExamenimpreso);
                    oldExamenImpresoOfAsignacionExamenimpresoListAsignacionExamenimpreso = em.merge(oldExamenImpresoOfAsignacionExamenimpresoListAsignacionExamenimpreso);
                }
            }
    ...
    public void edit(ExamenImpreso examenImpreso) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<AsignacionExamenimpreso> asignacionExamenimpresoListOld = persistentExamenImpreso.getAsignacionExamenimpresoList();
            List<AsignacionExamenimpreso> asignacionExamenimpresoListNew = examenImpreso.getAsignacionExamenimpresoList();
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListOldAsignacionExamenimpreso : asignacionExamenimpresoListOld) {
                if (!asignacionExamenimpresoListNew.contains(asignacionExamenimpresoListOldAsignacionExamenimpreso)) {
                    if (illegalOrphanMessages == null) {
                        illegalOrphanMessages = new ArrayList<String>();
                    }
                    illegalOrphanMessages.add("You must retain AsignacionExamenimpreso " + asignacionExamenimpresoListOldAsignacionExamenimpreso + " since its examenImpreso field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            List<AsignacionExamenimpreso> attachedAsignacionExamenimpresoListNew = new ArrayList<AsignacionExamenimpreso>();
            for (AsignacionExamenimpreso asignacionExamenimpresoListNewAsignacionExamenimpresoToAttach : asignacionExamenimpresoListNew) {
                asignacionExamenimpresoListNewAsignacionExamenimpresoToAttach = em.getReference(asignacionExamenimpresoListNewAsignacionExamenimpresoToAttach.getClass(), asignacionExamenimpresoListNewAsignacionExamenimpresoToAttach.getAsignacionExamenimpresoPK());
                attachedAsignacionExamenimpresoListNew.add(asignacionExamenimpresoListNewAsignacionExamenimpresoToAttach);
            }
            asignacionExamenimpresoListNew = attachedAsignacionExamenimpresoListNew;
            examenImpreso.setAsignacionExamenimpresoList(asignacionExamenimpresoListNew);
            ...
            for (AsignacionExamenimpreso asignacionExamenimpresoListNewAsignacionExamenimpreso : asignacionExamenimpresoListNew) {
                if (!asignacionExamenimpresoListOld.contains(asignacionExamenimpresoListNewAsignacionExamenimpreso)) {
                    ExamenImpreso oldExamenImpresoOfAsignacionExamenimpresoListNewAsignacionExamenimpreso = asignacionExamenimpresoListNewAsignacionExamenimpreso.getExamenImpreso();
                    asignacionExamenimpresoListNewAsignacionExamenimpreso.setExamenImpreso(examenImpreso);
                    asignacionExamenimpresoListNewAsignacionExamenimpreso = em.merge(asignacionExamenimpresoListNewAsignacionExamenimpreso);
                    if (oldExamenImpresoOfAsignacionExamenimpresoListNewAsignacionExamenimpreso != null && !oldExamenImpresoOfAsignacionExamenimpresoListNewAsignacionExamenimpreso.equals(examenImpreso)) {
                        oldExamenImpresoOfAsignacionExamenimpresoListNewAsignacionExamenimpreso.getAsignacionExamenimpresoList().remove(asignacionExamenimpresoListNewAsignacionExamenimpreso);
                        oldExamenImpresoOfAsignacionExamenimpresoListNewAsignacionExamenimpreso = em.merge(oldExamenImpresoOfAsignacionExamenimpresoListNewAsignacionExamenimpreso);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<AsignacionExamenimpreso> asignacionExamenimpresoListOrphanCheck = examenImpreso.getAsignacionExamenimpresoList();
            for (AsignacionExamenimpreso asignacionExamenimpresoListOrphanCheckAsignacionExamenimpreso : asignacionExamenimpresoListOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This ExamenImpreso (" + examenImpreso + ") cannot be destroyed since the AsignacionExamenimpreso " + asignacionExamenimpresoListOrphanCheckAsignacionExamenimpreso + " in its asignacionExamenimpresoList field has a non-nullable examenImpreso field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
