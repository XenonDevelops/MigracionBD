...
public class AlumnoJpaController implements Serializable {
    ...
    public void create(Alumno alumno) throws PreexistingEntityException, Exception {
        if (alumno.getAlumnoConvenioList() == null) {
            alumno.setAlumnoConvenioList(new ArrayList<AlumnoConvenio>());
        }
        ...
        try {
            ...
            for (AlumnoConvenio alumnoConvenioListAlumnoConvenioToAttach : alumno.getAlumnoConvenioList()) {
            ...
            alumno.setAlumnoConvenioList(attachedAlumnoConvenioList);
            ...
            for (AlumnoConvenio alumnoConvenioListAlumnoConvenio : alumno.getAlumnoConvenioList()) {
                Alumno oldAlumnoOfAlumnoConvenioListAlumnoConvenio = alumnoConvenioListAlumnoConvenio.getAlumno();
                alumnoConvenioListAlumnoConvenio.setAlumno(alumno);
                alumnoConvenioListAlumnoConvenio = em.merge(alumnoConvenioListAlumnoConvenio);
                if (oldAlumnoOfAlumnoConvenioListAlumnoConvenio != null) {
                    oldAlumnoOfAlumnoConvenioListAlumnoConvenio.getAlumnoConvenioList().remove(alumnoConvenioListAlumnoConvenio);
                    oldAlumnoOfAlumnoConvenioListAlumnoConvenio = em.merge(oldAlumnoOfAlumnoConvenioListAlumnoConvenio);
                }
            }
    ...
    public void edit(Alumno alumno) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<AlumnoConvenio> alumnoConvenioListOld = persistentAlumno.getAlumnoConvenioList();
            List<AlumnoConvenio> alumnoConvenioListNew = alumno.getAlumnoConvenioList();
            ...
            for (AlumnoConvenio alumnoConvenioListOldAlumnoConvenio : alumnoConvenioListOld) {
                if (!alumnoConvenioListNew.contains(alumnoConvenioListOldAlumnoConvenio)) {
                    ...
                    illegalOrphanMessages.add("You must retain AlumnoConvenio " + alumnoConvenioListOldAlumnoConvenio + " since its alumno field is not nullable.");
                }
            }
            ...
            alumno.setAlumnoConvenioList(alumnoConvenioListNew);
            ...
            for (AlumnoConvenio alumnoConvenioListNewAlumnoConvenio : alumnoConvenioListNew) {
                if (!alumnoConvenioListOld.contains(alumnoConvenioListNewAlumnoConvenio)) {
                    Alumno oldAlumnoOfAlumnoConvenioListNewAlumnoConvenio = alumnoConvenioListNewAlumnoConvenio.getAlumno();
                    alumnoConvenioListNewAlumnoConvenio.setAlumno(alumno);
                    alumnoConvenioListNewAlumnoConvenio = em.merge(alumnoConvenioListNewAlumnoConvenio);
                    if (oldAlumnoOfAlumnoConvenioListNewAlumnoConvenio != null && !oldAlumnoOfAlumnoConvenioListNewAlumnoConvenio.equals(alumno)) {
                        oldAlumnoOfAlumnoConvenioListNewAlumnoConvenio.getAlumnoConvenioList().remove(alumnoConvenioListNewAlumnoConvenio);
                        oldAlumnoOfAlumnoConvenioListNewAlumnoConvenio = em.merge(oldAlumnoOfAlumnoConvenioListNewAlumnoConvenio);
                    }
                }
            }
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<AlumnoConvenio> alumnoConvenioListOrphanCheck = alumno.getAlumnoConvenioList();
            for (AlumnoConvenio alumnoConvenioListOrphanCheckAlumnoConvenio : alumnoConvenioListOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Alumno (" + alumno + ") cannot be destroyed since the AlumnoConvenio " + alumnoConvenioListOrphanCheckAlumnoConvenio + " in its alumnoConvenioList field has a non-nullable alumno field.");
            }
