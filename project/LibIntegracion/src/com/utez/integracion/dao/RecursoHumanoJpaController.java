...
public class RecursoHumanoJpaController implements Serializable {
    ...
    public void create(RecursoHumano recursoHumano) {
        if (recursoHumano.getAsignacionTipomovimientorecursoList() == null) {
            recursoHumano.setAsignacionTipomovimientorecursoList(new ArrayList<AsignacionTipomovimientorecurso>());
        }
        ...
        try {
            ...
            for (AsignacionTipomovimientorecurso asignacionTipomovimientorecursoListAsignacionTipomovimientorecursoToAttach : recursoHumano.getAsignacionTipomovimientorecursoList()) {
            ...
            recursoHumano.setAsignacionTipomovimientorecursoList(attachedAsignacionTipomovimientorecursoList);
            ...
            for (AsignacionTipomovimientorecurso asignacionTipomovimientorecursoListAsignacionTipomovimientorecurso : recursoHumano.getAsignacionTipomovimientorecursoList()) {
                RecursoHumano oldRecursoHumanoOfAsignacionTipomovimientorecursoListAsignacionTipomovimientorecurso = asignacionTipomovimientorecursoListAsignacionTipomovimientorecurso.getRecursoHumano();
                asignacionTipomovimientorecursoListAsignacionTipomovimientorecurso.setRecursoHumano(recursoHumano);
                ...
                if (oldRecursoHumanoOfAsignacionTipomovimientorecursoListAsignacionTipomovimientorecurso != null) {
                    oldRecursoHumanoOfAsignacionTipomovimientorecursoListAsignacionTipomovimientorecurso.getAsignacionTipomovimientorecursoList().remove(asignacionTipomovimientorecursoListAsignacionTipomovimientorecurso);
                    oldRecursoHumanoOfAsignacionTipomovimientorecursoListAsignacionTipomovimientorecurso = em.merge(oldRecursoHumanoOfAsignacionTipomovimientorecursoListAsignacionTipomovimientorecurso);
                }
            }
    ...
    public void edit(RecursoHumano recursoHumano) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<AsignacionTipomovimientorecurso> asignacionTipomovimientorecursoListOld = persistentRecursoHumano.getAsignacionTipomovimientorecursoList();
            List<AsignacionTipomovimientorecurso> asignacionTipomovimientorecursoListNew = recursoHumano.getAsignacionTipomovimientorecursoList();
            ...
            for (AsignacionTipomovimientorecurso asignacionTipomovimientorecursoListOldAsignacionTipomovimientorecurso : asignacionTipomovimientorecursoListOld) {
                if (!asignacionTipomovimientorecursoListNew.contains(asignacionTipomovimientorecursoListOldAsignacionTipomovimientorecurso)) {
                    ...
                    illegalOrphanMessages.add("You must retain AsignacionTipomovimientorecurso " + asignacionTipomovimientorecursoListOldAsignacionTipomovimientorecurso + " since its recursoHumano field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            recursoHumano.setAsignacionTipomovimientorecursoList(asignacionTipomovimientorecursoListNew);
            ...
            for (AsignacionTipomovimientorecurso asignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso : asignacionTipomovimientorecursoListNew) {
                if (!asignacionTipomovimientorecursoListOld.contains(asignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso)) {
                    RecursoHumano oldRecursoHumanoOfAsignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso = asignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso.getRecursoHumano();
                    asignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso.setRecursoHumano(recursoHumano);
                    ...
                    if (oldRecursoHumanoOfAsignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso != null && !oldRecursoHumanoOfAsignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso.equals(recursoHumano)) {
                        oldRecursoHumanoOfAsignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso.getAsignacionTipomovimientorecursoList().remove(asignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso);
                        oldRecursoHumanoOfAsignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso = em.merge(oldRecursoHumanoOfAsignacionTipomovimientorecursoListNewAsignacionTipomovimientorecurso);
                    }
                }
            }
    ...
    public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<String> illegalOrphanMessages = null;
            List<AsignacionTipomovimientorecurso> asignacionTipomovimientorecursoListOrphanCheck = recursoHumano.getAsignacionTipomovimientorecursoList();
            for (AsignacionTipomovimientorecurso asignacionTipomovimientorecursoListOrphanCheckAsignacionTipomovimientorecurso : asignacionTipomovimientorecursoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This RecursoHumano (" + recursoHumano + ") cannot be destroyed since the AsignacionTipomovimientorecurso " + asignacionTipomovimientorecursoListOrphanCheckAsignacionTipomovimientorecurso + " in its asignacionTipomovimientorecursoList field has a non-nullable recursoHumano field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
